...
export const EmployeeProvider = ({ children }) => {
  ...
  const addEmployee = async (newEmployee) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/employees`, newEmployee);
  ...
  const updateEmployee = async (id, updatedEmployee) => {
    try {
      const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/employees/${id}`, updatedEmployee);
      setEmployees(prev =>
